...
@property (nonatomic, strong) KCountDownButton *countDownButton;
...
- (void)viewDidLoad {
    ...
    self.countDownButton = [[KCountDownButton alloc] initWithDuration:10 buttonClicked:^{
        //------- 按钮点击 -------//
...
- (void)dealloc {
   ...
   // [SVProgressHUD showSuccessWithStatus:@"页面已释放"];
}
